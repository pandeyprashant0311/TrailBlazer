...
float m[GRAPHSIZE][GRAPHSIZE] = {
	{0,1.33,0.56,-1.33,-0.55},
	{1.33,0,0,-10.6,-1.76},
	{0.56,-0.25,0,1.76,-10.6},
	{-1.33,-10.6,1.76,0,0},
	{-0.55,-1.76,-10.6,0.15,0}
};
...
void getCube1() {
	...
	drawString(35, 245, 0, (char*)"Patiala");
	glFlush();
}
void getCube2() {
	glBegin(GL_POLYGON);
	...
	glFlush();
	glColor3f(0.0, 0.0, 0.0);
	drawString(135, 410, 0, (char*)"Bangalore");
	glFlush();
}
void getCube3() {
	glBegin(GL_POLYGON);
	...
	glFlush();
	glColor3f(0.0, 0.0, 0.0);
	drawString(310, 410, 0, (char*)"Kolkata");
	glFlush();
}
void getCube4() {
	...
	glFlush();
	glColor3f(0.0, 0.0, 0.0);
	drawString(135, 80, 0, (char*)"Delhi");
	glFlush();
}
void getCube5() {
	glBegin(GL_POLYGON);
	...
	glFlush();
	glColor3f(0.0, 0.0, 0.0);
	drawString(310, 80, 0, (char*)"Chennai");
	glFlush();
}
...
void display2() {
	...
	glColor3f(1.0, 1.0, 1.0);
	drawString2(385, 235, 0, (char*)"Press the E or e to RUN");
...
void display1() {
	...
	glColor4f(1, 1, 1, 1.0);
	drawString1(125, 400, 0, (char*)" Thapar Institute of Engineering & Technology");
	glColor4f(1, 1, 1, 1.0);
	drawString1(125, 350, 0, (char*)" --TRAILBLAZZER--------------");
	glColor4f(1, 1, 1, 1.0);
	drawString1(125, 320, 0, (char*)" A Computer Graphics Project");
	glColor4f(1, 1, 1, 1.0);
	drawString1(125, 300, 0, (char*)" By Prashant, Khushi, Nimisha");
	glColor4f(1, 1, 1, 1.0);
	drawString1(125, 280, 0, (char*)" Roll No. 101903526, 101903509, 101903517");
	glLineWidth(5);
...
void display4() {
	...
	std::string str1 = "Time Taken = " + str + " seconds";
	char* sb = &str1[0];
	...
	if (a == b) {
		if (a == 1) {
			...
			drawString(10, 295, 0, (char*)"Source");
			drawString(10, 210, 0, (char*)"Destination");
			glFlush();
		}
		else if (a == 2) {
			getFinalCube2();
			glColor3f(0.0, 0.0, 1.0);
			drawString(110, 460, 0, (char*)"Source");
			drawString(110, 375, 0, (char*)"Destination");
			glFlush();
		}
		else if (a == 3) {
			getFinalCube3();
			glColor3f(0.0, 0.0, 1.0);
			drawString(285, 460, 0, (char*)"Source");
			drawString(285, 375, 0, (char*)"Destination");
			glFlush();
		}
		else if (a == 4) {
			getFinalCube4();
			glColor3f(0.0, 0.0, 1.0);
			drawString(110, 130, 0, (char*)"Source");
			drawString(110, 45, 0, (char*)"Destination");
			glFlush();
		}
		else {
			getFinalCube5();
			glColor3f(0.0, 0.0, 1.0);
			drawString(285, 130, 0, (char*)"Source");
			drawString(285, 45, 0, (char*)"Destination");
			glFlush();
		}
		glFlush();
	}
...
void display3() {
	...
	glColor3f(1.0, 1.0, 1.0);
	drawString1(135, 200, 0, (char*)" CALCULATING BEST PATH ");
	glLineWidth(3);
...
void mykey(unsigned char key, int x, int y) {
	...
	if ((key == 'E' || key == 'e') && flag == 0) {
		...
		getLines();
		glColor3f(0, 0, 0);
		drawString2(340, 235, 0, (char*)" Enter the number for Source Node");
		drawString2(340, 225, 0, (char*)" 1(Patiala), 2(Bangalore), 3(Kolkata), 4(Delhi), 5(Chennai)");
		...
		glFlush();
		glColor3f(1.0, 0.0, 0.0);
		drawString1(100, 400, 0, (char*)" Quit Key Pressed ");
		glFlush();
		for (i = 0; i <= 1500; i++) {
			delay();
		}
		...
		if (flag == 1) {
			flag = 2;
			drawString2(340, 235, 0, (char*)" Enter the number for Destination Node");
			drawString2(340, 225, 0, (char*)" 1(Patiala), 2(Bangalore), 3(Kolkata), 4(Delhi), 5(Chennai)");
			//source
			if (key == '1') {
				a = 1;
			...
			glFlush();
			glColor3f(1.0, 0.0, 0.0);
			drawString1(100, 400, 0, (char*)" Invalid Key Pressed ");
			glFlush();
			for (i = 0; i <= 1500; i++) {
				delay();
			}
...
void menu(int id) {
	...
	case 0:
		...
		getLines();
		glColor3f(1.0, 1.0, 1.0);
		drawString2(385, 235, 0, (char*)" Enter the number for Source Node");
		drawString2(385, 225, 0, (char*)"1(Patiala), 2(Bangalore), 3(Kolkata), 4(Delhi), 5(Chennai)");
...
void submenu1(int id) {
	if (flag == 1) {
		...
		flag = 2;
		if (dc != 1) {
			drawString2(385, 235, 0, (char*)" Enter the number for Destination Node");
			drawString2(385, 225, 0, (char*)"1(Patiala), 2(Bangalore), 3(Kolkata), 4(Delhi), 5(Chennai)");
		}
		switch (id) {
		case 1:
